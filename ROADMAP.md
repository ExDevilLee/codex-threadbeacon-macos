...
- 在 Settings 中提供总开关，并优先使用 macOS 系统提示音。

### 最小 Settings

- 配置刷新间隔、最大显示任务数和完成提示音。
- 管理已忽略任务，并支持恢复。
...
- `Token 消耗量`：先验证 Codex 本地数据是否能稳定区分单任务、单 turn 和累计消耗，再决定显示口径。
...
1. 任务右键菜单：置顶、忽略与恢复。
2. 完成提示音和最小 Settings。
3. Token、扩展状态与 subagent 数据可行性验证。
4. Codex CLI 兼容性 POC。
5. 国际化与主题设置。
6. Windows 版本评估与移植。
